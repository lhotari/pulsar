...
class SimpleAuthInitContext implements AuthenticationInitContext {
    ...
    SimpleAuthInitContext(PulsarHttpClientFactory httpClientFactory, ScheduledExecutorService scheduler, Clock clock,
            OpenTelemetry openTelemetry, String clientInstanceId, Map<String, String> params) {
