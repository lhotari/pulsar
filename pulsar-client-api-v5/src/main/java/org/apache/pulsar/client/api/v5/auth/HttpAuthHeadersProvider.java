...
public interface HttpAuthHeadersProvider {
     ...
     *
     * <p>The returned {@link HttpAuthHeaders} are attached to the request; most implementations
     * produce the same credential for every call. Completes exceptionally on failure (see the error
     * model in {@link org.apache.pulsar.client.api.v5.PulsarClientException}).
     *
