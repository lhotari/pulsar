...
/**
 * The reply from {@link ChallengeResponseHandler#respondToChallengeAsync} — the bytes for the next
 ...
 * context's state slot. Kept as a record rather than a bare {@code byte[]} so fields can be added
