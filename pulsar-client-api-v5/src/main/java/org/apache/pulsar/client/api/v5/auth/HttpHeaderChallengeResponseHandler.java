 ...
 *
 * <p>Handles the existing Pulsar SASL-over-HTTP mechanism, where the server returns HTTP
 * {@code 401} carrying the challenge in Pulsar's custom SASL headers (for example {@code SASL-Token}
