...
public class InflightReadsLimiterIntegrationTest extends MockedBookKeeperTestCase {
    ...
    public void testPreciseLimitation(String missingCase) throws Exception {
        ...
        entryCache.asyncReadEntry(spyCurrentLedger, 125, 125, __ -> Integer.MAX_VALUE, cb0, ctx);
        cb0.entries.join();
        ...
        threadFactory.newThread(() -> {
            entryCache.asyncReadEntry(spyCurrentLedger, start1, end1, __ -> Integer.MAX_VALUE, cb1, ctx);
        }).start();
        threadFactory.newThread(() -> {
            try {
            ...
            entryCache.asyncReadEntry(spyCurrentLedger, start2, end2, __ -> Integer.MAX_VALUE, cb2, ctx);
        }).start();
