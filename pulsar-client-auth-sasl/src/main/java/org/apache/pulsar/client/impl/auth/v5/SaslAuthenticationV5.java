 ...
 *
 * <p>The built-in v4 {@code AuthenticationSasl} drives this body on the async binary path; the
 * SASL-over-HTTP loop (the {@code authenticationStage} / {@code newRequestHeader} methods) remains on the
 * v4 shim (stage 3d). A fresh per-exchange SASL provider is obtained through the serializable
...
public class SaslAuthenticationV5 implements Authentication, BinaryAuthDataProvider,
        BinaryAuthChallengeHandler, Serializable {
