...
public class PersistentMessageFinderTest extends MockedBookKeeperTestCase {
    ...
    void testMessageExpiryWithPosition() throws Exception {
        ...
        assertEquals(cursor.getMarkDeletedPosition(), PositionImpl.get(positions.get(15).getLedgerId(),
        ...
        assertEquals(cursor.getMarkDeletedPosition(), PositionImpl.get(positions.get(16).getLedgerId(),
