...
public class BrokerEntryCacheTest extends ProducerConsumerBase {
    ...
    protected ServiceConfiguration getDefaultConf() {
        ...
        // increase default eviction threshold to reasonable value
        defaultConf.setManagedLedgerCacheEvictionTimeThresholdMillis(10000);
        // uncomment one of these to compare with existing caching behavior
        ...
        for (int i = 0; i < numConsumers; i++) {
            ...
            Thread consumerThread = new Thread(() -> {
                try {
                    ...
                    while (messagesReceived.size() < totalMessages &&
