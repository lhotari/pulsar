...
public class BrokerTestUtil {
    private static ScheduledExecutorService SINGLE_THREADED_EXECUTOR = createExecutorThatShutsDownIdleThreads(
            "broker-test-util-executor");

    private static ScheduledExecutorService createExecutorThatShutsDownIdleThreads(String poolName) {
        ScheduledExecutorService executor = Executors.newScheduledThreadPool(1, new DefaultThreadFactory(poolName));
