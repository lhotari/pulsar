...
import org.apache.pulsar.client.api.v1.V1ProducerConsumerBase;
...
public class V1ProxyAuthenticationTest extends V1ProducerConsumerBase {
    ...
    private static final Logger log = LoggerFactory.getLogger(V1ProxyAuthenticationTest.class);
}
