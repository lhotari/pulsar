...
public abstract class AbstractFileTest {
    ...
    protected final void generateFiles(int numFiles, int numLines) throws IOException, InterruptedException,
            ExecutionException {
    ...
    protected final void generateFiles(int numFiles, int numLines, String directory)
        ...
        generatorThread = new TestFileGenerator(producedFiles, numFiles, 1, numLines, directory,
                "prefix", ".txt", getPermissions());
