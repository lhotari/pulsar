...
- `producerResponsePacingMaxQueuedResponses` — bound on the number of responses held for one producer, escalating the same way. It bounds the pacing queue's memory, which no existing broker limit covers.
