 ...
 * a {@link org.apache.pulsar.client.api.v5.http.PulsarHttpClient} from the framework via
 ...
 * and selects each instance's TLS material by {@link org.apache.pulsar.common.tls.TlsPurpose}; plugins
 * describe what they need through a {@link org.apache.pulsar.client.api.v5.http.PulsarHttpClientConfig}.
 *
 * <p>The HTTP backend is framework-owned (built on AsyncHttpClient) and deliberately not pluggable. The
 * SPI is hosted in the neutral {@code pulsar-common-api} module so it can later serve other HTTP needs
 * inside Pulsar (e.g. broker-side JWKS fetching) without importing a client artifact.
 */
