...
public class TopicListWatcher extends HandlerState implements ConnectionHandler.Connection {
    ...
    private final Supplier<String> topicsHashSupplier;
    ...
    public TopicListWatcher(PatternConsumerUpdateQueue patternConsumerUpdateQueue,
                            ...
                            NamespaceName namespace, Supplier<String> topicsHashSupplier,
        ...
        this.topicsHashSupplier = topicsHashSupplier;
    ...
    public CompletableFuture<CommandWatchTopicListSuccess> reconcile() {
        ...
        return c.newWatchTopicList(requestId, watcherId, namespace.toString(),
                topicsPattern.inputPattern(), topicsHashSupplier.get());
    }
}
